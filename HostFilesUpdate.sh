...
curl --fail -o ${DMRHOSTS} -s http://barrandovhblink.jednoduse.cz/2024/DMR_Hosts.txt --user-agent "Pi-Star_${pistarCurVersion}"
...
curl --fail -o ${DMRIDFILE} -s http://barrandovhblink.jednoduse.cz/2024/DMRIds.dat --user-agent "Pi-Star_${pistarCurVersion}"
